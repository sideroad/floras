...
class Calendar extends Component {
  ...
  render() {
    ...
    const isEnablePrevMonth = !this.props.min ? true : start.isSameOrAfter(this.props.min);
    const isEnableNextMonth = !this.props.max ? true : end.isSameOrBefore(this.props.max);
      ...
      >
        ...
        >
          <div className={`${this.props.styles.calendar.control}`}>
            ...
            <div
              className={`${this.props.styles.calendar.month} ${
                this.props.styles.calendar[this.state.className]
              }`}
            >
          ...
          <table
            className={`${this.props.styles.calendar.table} ${
              this.props.styles.calendar[this.state.className]
            }`}
          >
            <thead>
                  ...
                  {__.times(7, (weekday) => {
                    ...
                    const dateClassName = [
                      __.some(this.props.selected, item =>
                        ...
                        ? this.props.styles.calendar.selected
                        : '',
                      dateOfWeekday.isSame(
                        moment.utc(this.props.today, 'YYYY-MM-DD').startOf('date')
                      )
                        ? this.props.styles.calendar.today
                        : __.some(this.props.holidays, item =>
                            dateOfWeekday.isSame(moment.utc(item).startOf('date'))
                          )
                        ? this.props.styles.calendar.holiday
                        : !dateOfWeekday.isSame(this.state.date, 'month')
                        ? this.props.styles.calendar.outside
                        : '',
                      ...
                      <td key={timeOfWeekday} className={this.props.styles.calendar.col}>
                        <div className={dateClassName}>
                          <div className={this.props.styles.calendar.date}>
                            {(this.props.min &&
                              moment
                                .utc(this.props.min, 'YYYY-MM-DD')
                                .toDate()
                                .getTime() > timeOfWeekday) ||
                            (this.props.max &&
                              moment
                                .utc(this.props.max, 'YYYY-MM-DD')
                                .toDate()
                                .getTime() < timeOfWeekday) ? (
